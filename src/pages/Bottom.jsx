...
function Bottom() {
  ...
  const toggleModal = () => {
    ...
    const response = await fetch(`${BASE_URL}${BOTTOM_ADD_ENDPOINT}`, {
      method: "POST",
      headers: {
        ...
        <nav className="relative z-10 bg-slate-900 backdrop-filter backdrop-blur-lg h-24 bg-opacity-20 border-b border-gray-200 rounded-t-lg">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between h-16">
              <span className="text-4xl mt-5 text-gray-900 font-bold">BOTTOM</span>
              <div className="flex space-x-0 text-gray-900">
              <p className=" mt-2 text-gray-800 font-semibold text-lg tracking-wide">
                    Filter by-
                  </p>
